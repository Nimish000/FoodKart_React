          ...
          <View>
            ...
            >
              <View style={{ flexDirection: "row" }}>
                <Image
                  source={require("../assets/drawables/google.png")}
                  style={{
                    height: AppUtil.getWP(7),
                    width: AppUtil.getWP(7),
                    resizeMode: "contain",
                  }}
                />
                <View
            ...
            {!isLoadMore && (
              <TouchableOpacity onPress={loadmoreHandler}>
                <Text
                  style={{
                    color: "white",
                    fontSize: dynamicFontSize * 1.2,
            ...
            {isLoadMore && (
              <View>
                ...
                >
                  <View style={{ flexDirection: "row" }}>
                    <Image
                      source={require("../assets/drawables/mail.png")}
                      style={{
                        height: AppUtil.getWP(7),
                        width: AppUtil.getWP(7),
                        resizeMode: "contain",
                ...
                <Pressable
                  onPress={() => navigation.navigate("SignInWithMobile")}
                  style={({ pressed }) => [
                    pressed && styles.pressed,
                    styles.pressable,
                  ]}
                >
                  <View style={{ flexDirection: "row" }}>
                    <Image
                      source={require("../assets/drawables/phone.png")}
                      style={{
                        height: AppUtil.getWP(7),
                        width: AppUtil.getWP(7),
                        resizeMode: "contain",
