...
// const{token,isAuthenticated,setToken}=useContext(AuthContext)

// useEffect(()=>{
//   async function fetchToken(){
//     console.log(`------> `)
//     const storedToken=await storage.getString('token')
//     console.log(`------> ${storedToken} not`)
...
//  if (isTryingLogin) {
//     return (<SplashScreenn/>)// or a splash screen
//   }
  ...
  function TabScreens() {
    ...
    function cartSvg({ fillColor }) {
      const cartIconSvg = `<svg width="144" height="108" viewBox="0 0 144 108" fill="none" xmlns="http://www.w3.org/2000/svg">
